...
#COPY . .
RUN git clone https://github.com/ShreyasBhagat2802/Docker_Chatapp.git /app
RUN echo $DB_HOST
...
CMD ["bash", "-c", "cd fundoo && python3 manage.py migrate && python3 manage.py runserver 0.0.0.0:8000"]
